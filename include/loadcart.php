...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    If (mysqli_num_rows($result) > 0)
    {
        ...
        If ($count == 2 or $count == 3 or $count == 4 or $count == 22 or $count == 23 or $count == 24 or $count == 32 or $count == 33 or $count == 34 or $count == 42 or $count == 43 or $count == 44 or $count == 52 or $count == 53 or $count == 54 or $count == 62 or $count == 63 or $count == 64) ( $str = ' товари');
